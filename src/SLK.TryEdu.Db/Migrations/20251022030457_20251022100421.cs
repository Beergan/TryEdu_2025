...
{
    /// <inheritdoc />
    public partial class _20251022100421 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GuidEmployee = table.Column<Guid>(type: "uuid", nullable: true),
                    EmployeeConnected = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OfficeGuid = table.Column<Guid>(type: "uuid", nullable: false),
                    Active = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Guid = table.Column<Guid>(type: "uuid", nullable: false),
                    GuidEmployeePost = table.Column<Guid>(type: "uuid", nullable: false),
                    NameEmployeePost = table.Column<string>(type: "text", nullable: true),
                    GuidEmployee = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TitleVi = table.Column<string>(type: "text", nullable: true),
                    Href = table.Column<string>(type: "text", nullable: true),
                    Guid_NoTifiCation = table.Column<Guid>(type: "uuid", nullable: false),
                    Guid_User = table.Column<Guid>(type: "uuid", nullable: false),
                    Guid_UserNoTify = table.Column<string>(type: "text", nullable: true),
                    Avatar = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecordGuid = table.Column<Guid>(type: "uuid", nullable: true),
