...
static void
wasm_invoke_iidddd (void *target_func, MonoInterpMethodArguments *margs)
{
	typedef int (*T)(int arg_0, double arg_1, double arg_2, double arg_3, double arg_4);
	T func = (T)target_func;
	int res = func (mono_wasm_interp_method_args_get_iarg (margs, 0), mono_wasm_interp_method_args_get_darg (margs, 0), mono_wasm_interp_method_args_get_darg (margs, 1), mono_wasm_interp_method_args_get_darg (margs, 2), mono_wasm_interp_method_args_get_darg (margs, 3));
	void *retval = mono_wasm_interp_method_args_get_retval (margs);
	*(int*)retval = res;
}
...
static unsigned int interp_to_native_signatures_count = 56;
